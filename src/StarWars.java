...
public class StarWars extends JPanel implements KeyListener, ActionListener
{
	...
	private ImageIcon ship, shipLeft, shipRight, shipUp, shipDown, enemy, beam, beamVer, beamHor, titleimg, title, luke;
	...
	{	
		...
		ship = new ImageIcon("shipUp.png");
		enemy = new ImageIcon("enemy.png");
		beam = new ImageIcon("");
		beamVer = new ImageIcon("beamVer.png");
		beamHor = new ImageIcon("beamHor.png");
		titleimg = new ImageIcon("titleimg.png");
		title = new ImageIcon("titlebrgrnd.png");
		luke = new ImageIcon("luke.png");
	...
	public void paint(Graphics g)
	{
		...
		if(titleCheck == true)
		{
			...
			g2.drawImage(titleimg.getImage(), 250, 400, this);
			g2.setFont(f);
